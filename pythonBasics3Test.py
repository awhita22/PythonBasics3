...
#Test case for ends_with_consonant
    def test_ends_with_consonant(self):
        ...
        self.assertEqual(pythonBasics3.ends_with_consonant("I want mac and cheese"), False)
        self.assertEqual(pythonBasics3.ends_with_consonant("I need a new calendar"), True)
        self.assertEqual(pythonBasics3.ends_with_consonant("My favorite show is Big Bang Theory"), True)
...
#Test case for ends_with_number
    def test_ends_with_number(self):
        ...
        # Please add three more test cases following the order above
        self.assertEqual(pythonBasics3.ends_with_number("My meeting is at 3"), True)
        self.assertEqual(pythonBasics3.ends_with_number("My favorite is a dolphin"), False)
        self.assertEqual(pythonBasics3.ends_with_number("I have 5 siblings"), False)
